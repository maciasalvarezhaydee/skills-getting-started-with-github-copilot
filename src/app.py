...
activities = {
    ...
    "Tennis Club": {
        "description": "Tennis practice and tournaments",
    ...
    "Drama Club": {
        "description": "Theater performance and script development",
    ...
    "Debate Team": {
        ...
        "max_participants": 12,
        "participants": ["aaron@mergington.edu", "grace@mergington.edu"]
    },
    "Science Club": {
